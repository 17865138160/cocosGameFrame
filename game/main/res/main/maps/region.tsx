...
<tileset name="region" tilewidth="48" tileheight="48" spacing="2" margin="1" tilecount="160" columns="8">
 <image source="../graphics/tilesets/region.png" width="400" height="1000"/>
 <tile id="0">
  <properties>
